...
echo "<div id='page-wrap'> <header class='main' id='h1'>";
    ...
    echo "<img style='max-width:120px; max-height:60px;' alt='imagen pregunta' src='".$foto."'/><br/><br/><span class='right'>Usuario: $email</span>
    ...
    <nav class='main' id='n1' role='navigation'>
                    ...
                    <span><a href='HandlingQuizesAjax.php?email=$email'> Preguntas con Ajax</a></span>
