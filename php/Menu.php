        ...
        echo "<div id='page-wrap'> <header class='main' id='h1'>";
            ...
            if ( $_SESSION['tipo_usuario'] == 'profesor' ) {
                ...
                if ( $_SESSION['admin'] == 0 ) {
                    ...
                    echo "
					<nav class='main' style='padding-top:300px;' id='n1' role='navigation'>
          <span style='padding:20px;'><h1>QUIZ</h1><br/><h3>el juego de las preguntas</h3></span>
					...
					<img style='max-width:120px; max-height:60px;' alt='imagen pregunta' src='".$foto."'/><br/><br/><span class='right'>Usuario: ".$_SESSION['user']."</span><br/><span class='right'>Ultimo acceso: ".$_SESSION['ultimo_acceso']."</span><br/><span class='right'>Rol: Profesor</span>
          ...
          <span style='padding:20px;'><h1>QUIZ</h1><br/><h3>el juego de las preguntas</h3></span>
					...
					<img style='max-width:120px; max-height:60px;' alt='imagen pregunta' src='".$foto."'/><br/><br/><span class='right'>Usuario: ".$_SESSION['user']."</span><br/><span class='right'>Ultimo acceso: ".$_SESSION['ultimo_acceso']."</span><br/><span class='right'>Rol: Administrador</span>
                        <span class='right'><br/><br/>".$modificar_pass."<a href='LogOut.php?destroy'><button type='button' class='btn btn-primary'> Logout &nbsp; <i class='icon-chevron-right'></i></button></a></span>
                ...
                echo "
                    ...
                    <nav class='main' id='n1'  style='padding-top:300px;' role='navigation'>
          <span style='padding:20px;'><h1>QUIZ</h1><br/><h3>el juego de las preguntas</h3></span>
                        <span><a href='Layout.php'>Inicio</a></span>
                            <span><a href='HandlingQuizesAjax.php'> Gestionar preguntas</a></span>
                        <span><a href='Credits.php'>Creditos</a></span>
					...
					<img style='max-width:120px; max-height:60px;' alt='imagen pregunta' src='".$foto."'/><br/><br/><span class='right'>Usuario: ".$_SESSION['user']."</span><br/><span class='right'>Ultimo acceso: ".$_SESSION['ultimo_acceso']."</span><br/><span class='right'>Rol: Alumno</span>
                    <span class='right'><br/><br/>".$modificar_pass."<a href='LogOut.php?destroy'><button type='button' class='btn btn-primary'> Logout &nbsp; <i class='icon-chevron-right'></i></button></a></span>
