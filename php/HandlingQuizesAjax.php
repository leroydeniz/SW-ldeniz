                ...
                <form id='fquestion' name='fquestion' enctype='multipart/form-data'><center>
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control" value="<?php echo $_SESSION['user']; ?>" style="text-align:center;background-color:#bbbbbb;"  id="emailform" size="60" readonly >
							</td>
                            <td rowspan="9">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control" name="enunciado" style="text-align: center" id="enunciado" size="60"  required/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" class="form-control" name="respuesta_correcta" style="text-align: center" id="respuesta_correcta" size="60" required/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" class="form-control" name="respuesta_mal1" style="text-align: center" id="respuesta_mal1" size="60"  required/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" class="form-control" name="respuesta_mal2" style="text-align: center" id="respuesta_mal2" size="60"  required/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" class="form-control" name="respuesta_mal3" style="text-align: center" id="respuesta_mal3" size="60"  required/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control" name="tema" id="tema" style="text-align: center" size="60"  required/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <br/><br/>	<input type="button" class='btn btn-primary' id="verpreguntas" value="Ver preguntas" onClick="ShowQuestions()"/> &nbsp; 
								<input type="button" class='btn btn-primary' id="enviarsolicitud" value="Enviar solicitud" /> &nbsp; 
								<input type="reset" class='btn btn-primary' value="Borrar" id="resetForm" onClick="ResetForm()"/>
                </form>
				<br/><br/>
