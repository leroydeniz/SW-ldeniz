...
<body>
  ...
  <section class="main" id="s1">
    <div>
        <h2>Crear pregunta con imagen</h2><br/><br/>
        <form id='fquestion' name='fquestion' action='AddQuestionWithImage.php' method="POST"  onsubmit="return validate_form();" enctype='multipart/form-data'><center>
            <table>
                <tr>
                    <td>
                        Email (*):
