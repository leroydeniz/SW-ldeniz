                ...
                <?php
                    ...
                    if(strlen($email) < 1) {
                        ...
                        #Email correcto, inicio*****
                            if(strlen(trim($enunciado)) < 10) {
                                echo "<script>alert(\"Enunciado vacío o menor a 10 caracteres\");document.location.href='QuestionFormWithImage.php?email=$email';</script>"; 
                            } else {
                            #Enunciado correcto, inicio*****
                                if(strlen($respuesta_correcta) < 1 || strlen($respuesta_mal1) < 1 || strlen($respuesta_mal2) < 1 || strlen($respuesta_mal3) < 1) {
                                    echo "<script>alert(\"Alguna de las respuestas está vacía\");document.location.href='QuestionFormWithImage.php?email=$email';</script>"; 
                                } else {
                                #Respuestas correctas, inicio*****
                                    if(strlen($tema) < 1) {
                                        echo "<script>alert(\"Tema de la pregunta no puede estar vacío\");document.location.href='QuestionFormWithImage.php?email=$email';</script>"; 
                                    } else {
