        ...
        <form name='fquestion' method='POST' action="" enctype='multipart/form-data'><center>
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="nombre_apellidos" id="nombre_apellidos" size="60" >
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="password" name="re_password" id="re_password" size="60" >
                    </td>
                </tr>
                <tr>
                    <td>
                        ...
                        if (!$mysqli) {
                            ...
                            if($existe!=0) {
                                ...
                                if($stmt = mysqli_prepare($mysqli,$sql)){
                                    ...
                                    mysqli_stmt_bind_param($stmt, "sssss", $email, $tipo, $nombre_apellidos, $password, $image);
